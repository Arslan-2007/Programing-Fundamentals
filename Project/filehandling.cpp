...
{
    fstream data;
    data.open("Medicine.txt", ios::out);
    data << count << "\n";
...
{
    fstream data;
    data.open("Employee.txt", ios::out);
    data << employeecount << "\n";
...
void updateMedicine()
{
    ...
    for (int i = 0; i < count; i++)
    {
        if (medicine[i] == name)
        {
            ...
            saveMedicine(); // save updated record
...
void deleteRecord()
{
    ...
    for (int i = 0; i < count; i++)
    {
        if (medicine[i] == name)
        {
            ...
            count--;
            saveMedicine(); // save record after delete specific record
            found = true;
    ...
    for (int i = 0; i < employeecount; i++)
    {
        if (employee[i] == name)
        {
            ...
            else if (choice == "salary")
            {
                ...
                cin >> salary[i];
                cout << "Salary status updated successfully." << endl;
                cout << "Press any key to continue...." << endl;
                getch();
            }
            saveEmployee(); // save updated record
        }
    }
    if (found == false)
    {
...
void deleteEmployeeRecord()
{
    ...
    for (int i = 0; i < employeecount; i++)
    {
        if (employee[i] == name)
        {
            ...
            employeecount--;
            saveEmployee(); // save record after deleting
